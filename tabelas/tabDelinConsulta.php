...
<html>
    <head>
     ...
     <script>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/delineadores/expDelineadores.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/delineadores/expDelineadoresSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/delineadores/expDelineadoresSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/delineadores/expDelineadoresSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/delineadores/expDelineadoresSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/delineadores/expDelineadoresBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/delineadores/expDelineadoresMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/delineadores/expDelineadoresSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/delineadores/expDelineadoresFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/delineadores/expDelineadoresBrava.php";  
        }
            }       
        </script>
    </head>
    ...
    <body>      
        <h1 class="op">DELINEADORES - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>           
          <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="delin" id="delin">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
        ...
        ?>
            ...
            <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>'Delineadores'</b> por Ilha</h1>
