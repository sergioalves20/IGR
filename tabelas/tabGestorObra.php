...
<html>
 ...
 ?>
    <body>               
        <h1 class="">GESTORES DE OBRA EM FUNÇÕES</h1>
        ...
        <table style="margin:0 auto;" width ="100%" border="1" class="tabela">
            <tr>  
                ...
                <td class="title" align="center" >ID Objecto<br>Concurso</td>
            ...
            $resultado = $dal->tabGestorObra($valor);
            While ($registo = $resultado->fetch_array()) {
                ?>     
                <tr>         
                    ...
                    <td class="tab"width="3%"style="color:brown;"><?php echo $registo["tipo_obra"]; ?></td>
