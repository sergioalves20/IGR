...
<html>
    ...
    <body>        
            <h1>BETÃO BETUMINOSO DE DESGASTE DA BERMA - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>
       <form class="tab" name='tab'method="post">
            <input type="text" name="bermasbbdsg" id='bermasbbdsg'placeholder="ID Estrada" />
            &nbsp;&nbsp;<input id="listar" style="background-color: #CD950C;width: 67px;" class="cmd" type="submit" name='localizar' value="Selecionar"/><br><br>
        </form>
            <p><a id="voltar"style="text-align:center;" href="../frms/frmBermasBbdsg.php">|VOLTAR|</a>
        <table style="margin:0 auto;" accept-charset="UTF-8" width ="80%" border="1" class="tabela">
            <tr>
                 <td class="title" align="center" >ID</td>
                    ...
                    <td class="title" align="center" >Espess.(cm)</td>
            ...
            if (filter_input(INPUT_POST, 'localizar')) {
                $valor = filter_input(INPUT_POST, 'bermasbbdsg');
            }
            $cx = new Conexao();
            $dal = new DALBermasbbdsg($cx);
            $resultado = $dal->TabBermasBbdsg($valor);
