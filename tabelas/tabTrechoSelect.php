...
<html>
    ...
    <body>               
       ...
       <form class="tab" name='tab'method="post">
           <input style="height: 20px; width: 120px"; type="text" name="idEstrada" id='idEstrada'placeholder="ID Estrada"  />
           &nbsp;&nbsp;<input id="listar" style="background-color: #CD950C;width:80px;" class="cmd" type="submit" name='localizar' value="Selecionar"/><br><br>
        </form>
        <table accept-charset="UTF-8" width ="200%" border="1" class="tabela">
            <tr>
