...
<html>
    <head>
       ...
       <script>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/cplanta/expCPlanta.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/cplanta/expCPlantaSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/cplanta/expCPlantaSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/cplanta/expCPlantaSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/cplanta/expCPlantaSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/cplanta/expCPlantaBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/cplanta/expCPlantaMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/cplanta/expCPlantaSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/cplanta/expCPlantaFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/cplanta/expCPlantaBrava.php";  
        }
            }
                     </script> 
    </head> 
 <?php include_once '../estrutura/header.php';?>
    <body>            
            <h1 class="op">CURVAS EM PLANTA - registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>                 
        <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="cplanta" id="cplanta">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
        ...
        ?>
                <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>'Curvas em Planta'</b> por Ilha</h1>
