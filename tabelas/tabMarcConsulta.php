...
<html>
   <head>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/marcadores/expMarcadores.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/marcadores/expMarcadoresSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/marcadores/expMarcadoresSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/marcadores/expMarcadoresSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/marcadores/expMarcadoresSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/marcadores/expMarcadoresBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/marcadores/expMarcadoresMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/marcadores/expMarcadoresSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/marcadores/expMarcadoresFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/marcadores/expMarcadoresBrava.php";  
        }
            }       
        </script>
    </head>
    ...
    <body>      
        <h1 class="op">MARCADORES - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>           
          <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="marc" id="marc">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
        ...
        ?>
            ...
            <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>'Marcadores'</b> por Ilha</h1>
