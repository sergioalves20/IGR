...
<html>
    <head>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/sepcentral/expSepCentral.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/sepcentral/expSepCentralSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/sepcentral/expSepCentralSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/sepcentral/expSepCentralSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/sepcentral/expSepCentralSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/sepcentral/expSepCentralBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/sepcentral/expSepCentralMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/sepcentral/expSepCentralSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/sepcentral/expSepCentralFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/sepcentral/expSepCentralBrava.php";  
        }
            }       
        </script>
    </head>
    ...
    <body>      
        <h1 class="op">SEPARADOR CENTRAL - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>           
          <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="sepcent" id="sepcent">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
        ...
        ?>
            ...
            <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>'Separador Central'</b> por Ilha</h1>
       ...
       <!------------------------------------------>
        ...
        <table  width ="115%" border="1" class="tabela">
            <tr> 
