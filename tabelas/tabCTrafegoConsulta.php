...
<html>
   ...
   <script>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/ctrafego/expCTrafego.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/ctrafego/expCTrafegoSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/ctrafego/expCTrafegoSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/ctrafego/expCTrafegoSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/ctrafego/expCTrafegoSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/ctrafego/expCTrafegoBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/ctrafego/expCTrafegoMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/ctrafego/expCTrafegoSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/ctrafego/expCTrafegoFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/ctrafego/expCTrafegoBrava.php";  
        }
            }       
        </script>
    </head>
    ...
    <body>      
        <h1 class="op">CONTAGEM DE TRÁFEGO - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>           
          <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="ctrafego" id="ctrafego">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
        ...
        ?>
            ...
            <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>'Contagem de Tráfego'</b> por Ilha</h1>
