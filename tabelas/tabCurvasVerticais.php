...
<html>
 ...
 <?php include_once '../estrutura/header.php';?>
    <body>
        <h1 class="">CURVAS VERTICAIS - registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1><br>            
       <form class="tab" name='tab'method="post">
         ...
         <div style="text-align: center;height: 30px;">
             <a id="voltar"style="text-align:center;" href="../frms/frmCurvasVerticais.php">|VOLTAR|</a>
         </div>
