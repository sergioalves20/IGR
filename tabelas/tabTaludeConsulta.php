...
<html>
    <head>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/talude/expTaludes.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/talude/expTaludesSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/talude/expTaludesSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/talude/expTaludesSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/talude/expTaludesSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/talude/expTaludesBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/talude/expTaludesMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/talude/expTaludesSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/talude/expTaludesFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/talude/expTaludesBrava.php";  
        }
            }
                     </script>
    </head> 
    ...
    <body>         
        <h1 class="">TALUDES - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>
        <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="talude" id="talude">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
        ...
        ?>
                <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>'Taludes'</b> por Ilha</h1>
