...
<html>
    ...
    <script>
        ...
        if(ilha === "Todas"){
           window.location.href = "../excel/iri/expIri.php";  
        }
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/iri/expIriSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/iri/expIriSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/iri/expIriSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/iri/expIriSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/iri/expIriBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/iri/expIriMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/iri/expIriSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/iri/expIriFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/iri/expIriBrava.php";  
        }
            }       
        </script>
    </head>
    ...
    <body>      
        <h1 class="op">I.R.I.(International Roughness Index) - Registos válidos anteriores a&nbsp;<?php echo date('Y-m-d'); ?></h1>           
          <form style="margin:10px auto;width: 280px;" class="tab" name='tab'method="post">
                    <select style="height: 30px;width: 200px;color: #000099;" name ="iri" id="iri">  
                        <?php
                        $estrada = "";
                        $cx = new Conexao();
                        $dal = new DALIri($cx);
        ...
        ?>
            ...
            <!---------------------------------------------------------------->
        <h1 style="color:green">Exportar <b>' I.R.I.'</b> por Ilha</h1>
