...
<html>
   ...
   <script>
        ...
        if(ilha === "Santo Antão"){
           window.location.href = "../excel/drensuperf/expDrensupfSAntao.php";  
        }
        if(ilha === "São Vicente"){
           window.location.href = "../excel/drensuperf/expDrensupfSVicente.php";  
        }
         if(ilha === "São Nicolau"){
           window.location.href = "../excel/drensuperf/expDrensupfSNicolau.php";  
        }
         if(ilha === "Sal"){
           window.location.href = "../excel/drensuperf/expDrensupfSal.php";  
        }
         if(ilha === "Boa Vista"){
           window.location.href = "../excel/drensuperf/expDrensupfBVista.php";  
        }
         if(ilha === "Maio"){
           window.location.href = "../excel/drensuperf/expDrensupfMaio.php";  
        }
         if(ilha === "Santiago"){
           window.location.href = "../excel/drensuperf/expDrensupfSantiago.php";  
        }
         if(ilha === "Fogo"){
           window.location.href = "../excel/drensuperf/expDrensupfFogo.php";  
        }
         if(ilha === "Brava"){
           window.location.href = "../excel/drensuperf/expDrensupfBrava.php";  
        }
            }       
        </script>
    </head>
