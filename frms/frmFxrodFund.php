...
<html>
    <head>
        ...
        <style>select#cNatgeo{height: 25px;width: 100px;}
               ...
               form#fund{width:900px;height:200px;}
               </style>     
         <?php
        ...
        if (filter_has_var(INPUT_POST, 'tGuardar')) {
            ...
            $fxrodfund = new Fxrodfund(0,$alt, $reg, $id_estrada, $id_fxrod, $data, $hora, $pkinicio, $pkfim, $via, $natgeo, $cbr, $ass);
            $cx = new Conexao();
            $dalfxrodfund = new DALFxrodFund($cx);
            $dalfxrodfund->Inserir($fxrodfund);
            $fxrodfund = new Fxrodfund();
