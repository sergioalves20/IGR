...
//Alterar registo
    ...
    <body>      
        ...
        <form style="height:390px;width: 650px;" method="post" onsubmit="return pk()" name='intersecao'  action="../estrutura/levantamento_main.php?pg=intersecao&op=listar"  >	
            ...
            <p><label class="label_1" for="cAlterar">Alteração</label>
                ...
                <input value="<?php echo $intrs->getReg(); ?>"type="text" name ="tReg"  id="cReg" class="align" size= "2"placeholder="0"/>   
