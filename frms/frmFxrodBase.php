...
<html>
    <head>
        ...
        if (filter_has_var(INPUT_POST, 'tGuardar')) {
            ...
            $fxrodbase = new FxrodBase(0,$alt,$reg, $id_fxrod, $id_estrada, $data, $hora, $pkinicio, $pkfim, $via, $natgeo, $granul, $espess, $ass);
            $cx = new Conexao();
            $dal = new DALFxrodBase($cx);
            $dal->Inserir($fxrodbase);
            $fxrodbase = new Fxrodbase();
            ...
            if (filter_has_var(INPUT_POST, 'btalterar')) {
                ...
                $dalfxrodbase->Alterar($fxrodbase);
                $fxrodbase = new Fxrodbase();
            }
            //Excluir registo
    ...
    <body>
        ...
        <form style="width:900px;height: 200px;"method="post" id="base" action="../estrutura/levantamento_main.php?pg=fxrodbase&op=listar"onsubmit="return pk()">         
