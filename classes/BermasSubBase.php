...
class BermasSubBase extends EstradaFicha {
    private $id_bermasubbase;
    private $id_berma;
    private $natgeo;
    private $granul;
    private $espess;

    public function __construct($id_bermasubbase=0,$alt="",$reg="", $id_berma="",  $id_estrada="", $data="", $hora="", $pkinicio="", $pkfim="", $natgeo="", $granul="", $espess="", $sentido="", $ass="") {
        $this->setId_bermasubbase($id_bermasubbase); 
        $this->setAlt($alt);
        $this->setReg($reg);
     ...
     public function getId_bermasubbase() {
        return $this->id_bermasubbase;
    }
    ...
    public function setId_bermasubbase($id_bermasubbase) {
        $this->id_bermasubbase = $id_bermasubbase;
    }
