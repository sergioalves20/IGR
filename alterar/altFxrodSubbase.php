...
//Retificar registo
    ...
    <body>
        ...
        <form style="width: 900px;height: 460px;" method="post" id="subbase" action="../estrutura/levantamento_main.php?pg=fxrodsubbase&op=listar"onsubmit="return pk()">         
        ...
        <br>
            ...
            <a id="voltar"style="text-align:center;" href="alterar_main.php?pg=fxrodsubbase">|INÍCIO|</a>
            <footer>
